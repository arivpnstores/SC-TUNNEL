...
# Author  : LORD
# (C) Copyright 2021-2022 By MAZ FARUK 
# =========================================
...
echo -e "         OWNER : ${GREEN} ARI ${NC}${YELLOW}(${NC} ${GREEN} LORD  ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By ARISCTUNNEL${YELLOW}(${NC} 2023-2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
