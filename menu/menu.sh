...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/arivpnstores/izin/main/ipmini > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/arivpnstores/izin/main/ipmini | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/arivpnstores/izin/main/ipmini | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/arivpnstores/izin/main/ipmini | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/arivpnstores/izin/main/versions)
...
11) clear ; wget https://raw.githubusercontent.com/arivpnstores/izin/main/kyt.sh && chmod +x kyt.sh && ./kyt.sh ;;
12) clear ; lock ;;
13) clear ; unlock ;;
14) clear ; update ;;
0) clear ; menu ;;
